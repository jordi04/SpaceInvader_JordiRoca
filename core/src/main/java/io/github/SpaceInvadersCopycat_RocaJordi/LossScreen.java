...
public class LossScreen implements Screen {
    ...
    public LossScreen(final Main game, int score) {
        this.game = game;
        this.score = score;
    ...
    private void createStyles() {
        ...
        titleStyle = new Label.LabelStyle(game.titleFont, Color.RED);
        scoreStyle = new Label.LabelStyle(game.font, Color.WHITE);
    }

    private void createLossUI() {
        Table table = new Table();
        table.setFillParent(true);
        table.center();

        // Títol
        Label lossLabel = new Label("GAME OVER", titleStyle);
        ...
        table.add(lossLabel).padBottom(10).row();
